...
class PHPExcel_Shared_Drawing
{
     ...
     */
    public static function pixelsToCellDimension(PHPExcel_Style_Font $pDefaultFont, int $pValue = 0): float
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();

        // Verificar que el tamaño de la fuente y el nombre de la fuente existan en los datos
        if (isset(PHPExcel_Shared_Font::$defaultColumnWidths[$name][$size])) {
            // Determinar el ancho exacto
            ...
            // Si no tenemos datos para esta fuente en particular, usamos una aproximación
            if (isset(PHPExcel_Shared_Font::$defaultColumnWidths['Calibri'][11])) {
                // Extrapolar usando Calibri 11 como referencia
                ...
                // Manejo de error en caso de que los datos de Calibri 11 tampoco estén disponibles
                throw new Exception("Datos para la fuente Calibri 11 no disponibles.");
            }
        }
