...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
 ...
 // Obtener la instancia de PHPExcel_Calculation para la hoja de cálculo actual
 $calculationInstance = PHPExcel_Calculation::getInstance($this->spreadSheet);

 // Verificar si la instancia de cálculo y el DebugLog son válidos
 if ($calculationInstance !== null && $calculationInstance->getDebugLog() !== null) {
     $saveDebugLog = $calculationInstance->getDebugLog()->getWriteDebugLog();
     
     // Desactivar temporalmente la escritura del DebugLog
     $calculationInstance->getDebugLog()->setWriteDebugLog(false);
 } else {
     // Si el DebugLog no está disponible, continúa sin manipularlo
     $saveDebugLog = false;
 }
 
 // Establecer el tipo de retorno de fecha
 ...
 PHPExcel_Calculation_Functions::setReturnDateType(PHPExcel_Calculation_Functions::RETURNDATE_EXCEL);
            ...
            // Verificar si la instancia de cálculo y el DebugLog son válidos
            if ($calculationInstance !== null && $calculationInstance->getDebugLog() !== null) {
                $calculationInstance->getDebugLog()->setWriteDebugLog($saveDebugLog);
            }
            // Close file
